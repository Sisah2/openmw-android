...
cp prefix/$ARCH/lib/{libopenal,libSDL2,libdriver_helper,liblinkerhook,libOSMesa_8,libvulkan_freedreno,libVkLayer_khronos_timeline_semaphore,libcollada-dom2.5-dp}.so ../app/src/main/jniLibs/$ABI/
